...
const About = () => {
  return (
    <section className="flex flex-col gap-8 px-8 max-w-screen-xl mx-auto">
      <h1 className="text-4xl font-titulo text-center text-gray-900 dark:text-white pt-12 mb-12 relative inline-block after:content-[''] after:block after:h-1 after:w-16 after:bg-blue-800 after:mx-auto after:mt-2">
        Sobre nós
      </h1>

      <div className="flex flex-col lg:flex-row gap-12 items-center ">
        <div className="flex-1 font-texto text-left text-gray-600  dark:text-white">
          <p className="mb-4">
        ...
        <div className="grid grid-cols-2 gap-4 self-center">
          <div className="flex gap-3 flex-col items-center justify-center text-center aspect-square bg-green-50 rounded-xl p-4">
            <h3 className="font-semibold font-titulo dark:text-black">Gastronomia</h3>
          ...
          <div className="flex gap-3 flex-col items-center justify-center text-center aspect-square bg-indigo-50 rounded-xl p-4">
            <h3 className="font-semibold font-titulo dark:text-black">Bebidas</h3>
            <p className="text-sm font-texto  text-gray-600">
          ...
          <div className="flex gap-3 flex-col items-center justify-center text-center aspect-square bg-yellow-50 rounded-xl p-4">
            <h3 className="font-semibold font-titulo dark:text-black">Ambiente</h3>
            <p className="text-sm font-texto  text-gray-600">
          ...
          <div className="flex gap-3 flex-col items-center justify-center text-center aspect-square bg-rose-50 rounded-xl p-4">
            <h3 className="font-semibold font-titulo dark:text-black">Experiência</h3>
            <p className="text-sm font-texto  text-gray-600">
